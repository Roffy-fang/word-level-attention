...
function LSTM.lstm(input_size, rnn_size, n, dropout)
  ...
  for L = 1,n do
    ...
    if dropout > 0 then prev_h = nn.Dropout(dropout/2)(prev_h):annotate{name='drop_' .. L} end -- apply dropout, if any
--      if dropout > 0 then prev_c = nn.Dropout(dropout/2)(prev_c):annotate{name='drop_' .. L} end -- apply dropout, if any
